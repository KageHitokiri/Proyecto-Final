 ...
 */
final class Version20220201160715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_character (id INT AUTO_INCREMENT NOT NULL, character_name VARCHAR(255) NOT NULL, max_hp VARCHAR(255) NOT NULL, hp INT NOT NULL, max_stamina INT NOT NULL, stamina INT NOT NULL, max_essence INT NOT NULL, essence INT NOT NULL, gold INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
